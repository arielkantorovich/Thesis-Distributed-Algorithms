...
###################### This example optimize parallel equation ######################################
...
for i in range(L):
    print(f"Trial {i + 1}:")
    print("Optimal power allocation:", optimal_power_allocations[i])
    print("Optimal value of the objective function:", optimal_objective_values[i])
...
#
# # # run my loop code
# P_record, global_record, grad_record = multi_wireless_loop(N, L, T, g, learning_rate, 0, P)
# print(f"Total objective={global_record[T-1]} ")
#
# # Plot results
# # t = np.arange(T)
# # plt.figure(1)
